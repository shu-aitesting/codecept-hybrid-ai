...
declare namespace CodeceptJS {
  interface SupportObject { I: I, current: any, headerFragment: headerFragment, modalFragment: modalFragment, navbarFragment: navbarFragment, loginForm: loginForm, loginPage: loginPage, dashboardPage: dashboardPage, authSteps: authSteps }
